...
Container,Content,Form,Spacer,PreviewContainer, Dropzone,PreviewImage,Preview,AddContainer,AddButton,AddIcon,IconWrapper,
...
function PdfToPpt() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setIsLoading(true)
      setIsError('')
      await base_url.post('pdf_to_ppt/'+user.id+'/', formData, {
        headers: {
          ...
          {data.file && 
            <Container>
              ...
              <Form onSubmit={handleSubmit}>
                <FileTitle>PDF to PPT</FileTitle>
                <Spacer></Spacer>
                {/* <Group>
