...
import axios from 'axios';
 import { ConversionForm, DownloadButton, DownloadWrapper, FileInput, FileInputContainer, FileTitle, FormTitle,PdfToWordPageContainer, SubmitButton, UploadIcon, UploadText, Error,RefreshButton,RefreshIcon,
 Container,Content,Form,Spacer,PreviewContainer, Dropzone,PreviewImage,Preview,AddContainer,AddButton,AddIcon,
 IconWrapper,FileInputLabel,FileName} from './Styles'
...
function ExcelToPdf() { 
  ...
  const { getRootProps, getInputProps } = useDropzone({
    onDrop: onDrop,
    // accept: application/ppt, application/vnd.ms-powerpoint, application/vnd.openxmlformats-officedocument.presentationml.presentation"
    accept: {
        ...
        {!convertedFile && <>
          {!data.file && <>
           <Dropzone {...getRootProps()} >
              <FormTitle>Drag 'n' drop a Excel file here</FormTitle>
              <FileInputContainer>
          ...
          {data.file && 
            <Container>
              <Content>
                  ...
                  <PreviewContainer>
                    <Preview>
                      <PreviewImage src={require('../../Assets/Images/excel.png')} alt={`Page`} />
                      <FileName>{data.file.name}</FileName>
                    </Preview>
                  </PreviewContainer>
              </Content>
              <Form onSubmit={handleSubmit}>
                <FileTitle>Excel to PDF</FileTitle>
                <Spacer></Spacer>
                {/* <Group>
