...
import axios from 'axios';
 import { ConversionForm, DownloadButton, DownloadWrapper, FileInput, FileInputContainer, FileTitle, FormTitle,
  ...
  Form,Spacer,PreviewContainer, Dropzone,PreviewImage,Preview,AddContainer,AddButton,AddIcon,IconWrapper,
...
function PdfToExcel() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setIsLoading(true)
      setIsError('')
      await base_url.post('pdf_to_excel/'+user.id+'/', formData, {
        headers: {
          ...
          {data.file && 
            <Container>
              ...
              <Form onSubmit={handleSubmit}>
                <FileTitle>PDF to Excel</FileTitle>
                <Spacer></Spacer>
                {/* <Group>
