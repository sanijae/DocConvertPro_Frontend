...
import axios from 'axios';
 import { ConversionForm, DownloadButton, DownloadWrapper, FileInput, FileInputContainer, FileTitle, 
  FormTitle,PdfToWordPageContainer, SubmitButton, UploadIcon, UploadText, Error,RefreshButton,RefreshIcon,Container,
...
function PdfToPng() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setIsLoading(true)
      setIsError('')
      await base_url.post('pdf_to_png/'+user.id+'/', formData, {
        headers: {
          ...
          {data.file && 
            <Container>
              ...
              <Form onSubmit={handleSubmit}>
                <FileTitle>PDF to PNG</FileTitle>
                <Spacer></Spacer>
                {/* <Group>
