...
function ProtectPdf() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setIsLoading(true)
      setIsError('')
      await base_url.post('protect_pdf/'+user.id+'/', formData, {
        headers: {
          ...
          {data.file && 
            <Container style={styles.container}>
              <Content style={styles.content}>
                  ...
                  <PreviewContainer>
                    <Preview>
                      <PreviewImage src={require('../../Assets/Images/sec-pdf.png')} alt={`Page`} />
                    </Preview>
                  </PreviewContainer>
              </Content>
              <Form style={styles.form}>
                <FileTitle>Protect PDF</FileTitle>
                <Spacer></Spacer>
                <Group>
                ...
                <SubmitButton type="submit">Protect</SubmitButton>
              </Form>
            </Container>} 
          </>}
          {convertedFile && (
