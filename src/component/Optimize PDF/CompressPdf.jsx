          ...
          {data.file && 
            <Container>
              <Content>
                  ...
                  <PreviewContainer>
                    <Preview>
                      <PreviewImage src={require('../../Assets/Images/compress.png')} alt={`Page`} />
                    </Preview>
                  </PreviewContainer>
              </Content>
              <Form onSubmit={handleSubmit}>
                <FileTitle>Compress PDF</FileTitle>
                <Spacer></Spacer>
                {/* <Group>
                ...
                <SubmitButton type="submit">Compress</SubmitButton>
              </Form>
            </Container>}
          </>}
          {convertedFile && (
